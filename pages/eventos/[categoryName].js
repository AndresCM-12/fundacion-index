...
import EventosBanner from "@/components/banners/eventosBanner";
...
const JardinPage = ({ post, navData, postIndex, mainLayoutNavData }) => {
  ...
  return (
    <MainLayout navData={mainLayoutNavData} title="Jardín de niños Index">
      <EventosBanner className="bg-index-aqua" />
...
export async function getServerSideProps({ params }) {
  const data = await getPostsFromCategories("eventos");
  if (!data) {
    return {
      props: {
