...
export default function DynamicListComponent({ data }) {
            ...
            >
              ...
              <Disclosure.Panel>
                <div className="contentcontainer font-albra text-lg py-7 lg:px-7">
                  Hacer entrega de la documentación en las instalaciones de
                  Index Chihuahua®. <br />
            ...
            >
              ...
              <Disclosure.Panel>
                <div className="contentcontainer font-albra py-7 text-lg lg:px-7">
                  La documentación será revisada para identificar si el donativo
                  solicitado se encuentra dentro de las líneas de apoyo de
                  Fundación Index Chihuahua®. <br />
                </div>
        ...
        <Disclosure>
          {({ open }) => (
            ...
            >
              ...
              <Disclosure.Panel>
                <div className="contentcontainer font-albra py-7 text-lg lg:px-7">
                  Si la solicitud se encuentra dentro de las líneas de apoyo de
                  Fundación Index Chihuahua®, se comunicarán con la asociación
                  para informarle que deberán realizar una presentación ante al
                  Comité de Responsabilidad Social, donde se les podrán realizar
                  preguntas sobre el proyecto que posteriormente evaluarán.{" "}
                  <br /> El Comité determinará cuáles proyectos pasarán a
                  autorización por el Consejo Directivo. <br /> (El Comité de
                  Responsabilidad Social en la Ciudad de Chihuahua sesiona de
                  manera mensual y está conformado por responsables de las áreas
                  de Responsabilidad Social, Recursos Humanos, Medio Ambiente,
                  Seguridad e Higiene de las empresas donantes de Fundación
                  Index Chihuahua®). Chihuahua Camargo/Jiménez Delicias
                  Cuauhtémoc
                </div>
        ...
        <Disclosure>
          {({ open }) => (
            ...
            >
              ...
              <Disclosure.Panel>
                <div className="contentcontainer font-albra py-7 text-lg lg:px-7">
                  La presentación deberá estar respaldada por material de apoyo
                  en formato PowerPoint con una duración máxima de 10 minutos,
                  que deberá ser entregada con tres días hábiles de anticipación
                  a Fundación Index Chihuahua® con respecto a la fecha que se
                  les calendarizó su presentación. Deberán acudir un máximo de 2
                  personas.
                  <br />
                </div>
                ...
                <div className="listcontainer  lg:px-7">
                  ...
                  <ul>
                    ...
                    <li className="border-b-2 py-4 border-index-border flex justify-start items-start">
                      <MiniCircle />
                      <p className="pl-4  font-normal text-lg leading-6 font-albra">
                        Descripción del proyecto y cantidad de beneficiarios a
                        atender (si incluye a colaboradores de la industria
                        manufacturera identificar cuántos, en qué zona
                        geográfica se encuentran y de ser posible identificar
                    ...
                    <li className="border-b-2 py-4 border-index-border flex justify-start items-start">
                      <MiniCircle />
                      <p className="pl-4  font-normal text-lg leading-6 font-albra">
                        Descripción detallada en lo cual va a ser utilizada la
                        cantidad solicitada.{" "}
                      </p>
                    </li>
                    <li className="border-b-2 py-4 border-index-border flex justify-start items-start">
                      <MiniCircle />
                      <p className="pl-4  font-normal text-lg leading-6 font-albra">
                        Mencionar si es asociación analizada por Confío A.C. y
                        año de su último análisis.{" "}
                      </p>
                    </li>
                  </ul>
                </div>
          ...
          {({ open }) => (
            ...
            >
              ...
              <Disclosure.Panel>
                <div className="contentcontainer font-albra text-lg py-7 lg:px-7">
                  <p>
                    Si el Comité de Responsabilidad Social aprueba el proyecto
                    se turnará a Consejo Directivo para su resolución final.
                  </p>{" "}
                  <br />
                  <p>
                    De ser la resolución del Consejo Directivo de Fundación
                    Index Chihuahua® positiva, se le notificará de manera
                    escrita.
                  </p>
                  <br />
                  <p>
                    (En algunos casos el Consejo Directivo realiza observaciones
                    que se incluirán en la carta de resolución, las cuales
                    deberán de ser cumplidas para la total aprobación del
                    proyecto.)
                  </p>{" "}
                  <br />
                  <p>
                    {" "}
                    El Consejo Directivo sesiona de manera mensual al igual que
